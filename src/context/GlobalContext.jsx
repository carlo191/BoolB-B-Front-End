...
export const GlobalProvider = ({ children }) => {
	...
	const storeReview = (review) => {
		fetch(`http://localhost:3000/review`, {
			...
			body: JSON.stringify({
				...
				nome_utente: capitalizeFirstLetter(review.nome_utente),
				contenuto: capitalizeFirstLetter(review.contenuto),
				voto: review.voto,
	...
	const storeProperty = (newProperty) => {
		...
		fetch(`http://localhost:3000/property`, {
			...
			body: JSON.stringify({
				nome: capitalizeFirstLetter(newProperty.nome),
				...
				indirizzo: capitalizeFirstLetter(newProperty.indirizzo),
